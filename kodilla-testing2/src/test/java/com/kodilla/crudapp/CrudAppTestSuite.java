...
public class CrudAppTestSuite {
    ...
    private static final String BASE_URL = "https://dawidmagnucki.github.io/Tasks-Application/";
    ...
    private void deleteTaskFromCrudApp(String taskName) throws InterruptedException {
        ...
        driver.findElements(
                        By.xpath("//form[@class=\"datatable_row\"]"))
                .stream()
                .filter(anyForm -> anyForm.findElement(
                                By.xpath(".//p[@class=\"datatable_field-value\"]"))
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("david.magnucki@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("!KodillaBootcamp02.07.25");
