...
public class CrudAppTestingApp {
    ...
    private static final String XPATH_TEXTAREA = "//html/body/main/section[1]/form/fieldset[2]/textarea";
    ...
    public static void main(String[] args) {
        ...
        driver.get("https://dawidmagnucki.github.io/Tasks-Application/");
